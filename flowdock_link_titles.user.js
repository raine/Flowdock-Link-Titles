...
function linkTitles(jQuery) {
   ...
   * Commit: b4ae2a2
   * Date: Wed Jun 16 22:50:01 2010 +0300
   */
  ...
  " and xpath='"+b.xpath+"'";b={q:a,diagnostics:"false",format:"json"};this.debug&&console.debug(b);window.syqlcb=function(g){d(g.query.results);delete window.syqlcb};b=e.toURI("http://query.yahooapis.com/v1/public/yql",b);jQuery.ajax({url:b,dataType:"jsonp",cache:"true",jsonpCallback:"syqlcb"})}}}();
